...
# _CONFIG_FOR_DOC = "MeditronLlamaConfig"
    ...
    def forward(
        ...
        if labels is not None:
            ...
            if self.config.problem_type is None:
                ...
                #     print("Binary classification problem type")
                if self.num_labels == 1:
            ...
            if self.config.problem_type == "regression":
                ...
                loss_fct = BCEWithLogitsLoss()
                loss = loss_fct(pooled_logits, labels.float()) # changed labels to labels.float() on 05-22-24
        if not return_dict:
