...
class BootstrapMultiLabelMetrics(object):
    ...
    def get_all_bootstrapped_metrics_as_dict(self, n_bootstrap=1000):
        ...
        micro_average_precision_mean_stdv, macro_average_precision_mean_stdv = self.get_bootstrapped_average_precision(n_bootstrap=n_bootstrap)
        micro_roc_auc_mean_stdv, macro_roc_auc_mean_stdv = self.get_bootstrapped_roc_auc(n_bootstrap=n_bootstrap)
        micro_f1_mean_stdv, macro_f1_mean_stdv = self.get_bootstrapped_f1(n_bootstrap=n_bootstrap)
...
def compute_training_metrics(pred, threshold=0.5):
    """
