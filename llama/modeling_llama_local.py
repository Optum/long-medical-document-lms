        ...
        if labels is not None:
            ...
            if self.config.problem_type is None:
                if self.num_labels == 1:
                    ...
                    # print("Running multi-label classification forward pass...") # added 05-15-24
            ...
            if self.config.problem_type == "regression":
                ...
                loss = loss_fct(pooled_logits, labels.float()) # changed labels to labels.float() on 05-15-24
        if not return_dict:
